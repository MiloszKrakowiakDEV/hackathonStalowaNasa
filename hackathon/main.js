let players = [
    {name: "Player 1", position: 0, correctAnswersInRow: 0, className: 'player1'},
    {name: "Player 2", position: 0, correctAnswersInRow: 0, className: 'player2'},
    {name: "Player 3", position: 0, correctAnswersInRow: 0, className: 'player3'},
    {name: "Player 4", position: 0, correctAnswersInRow: 0, className: 'player4'}
];
